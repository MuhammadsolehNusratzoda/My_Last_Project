...
/// <summary>
/// Enforces business validation rules for UpdateHotelCommand parameters.
/// </summary>
public class UpdateHotelCommandValidator : AbstractValidator<UpdateHotelCommand>
{
    public UpdateHotelCommandValidator()
    {
        ...
        RuleFor(x => x.AvailableRooms)
            .GreaterThanOrEqualTo(0).WithMessage("Available rooms count must be greater than or equal to 0.")
